...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static final Color BLACK_PIECES     = new Color(0, 0, 0);
    public static final Color WHITE_PIECES     = new Color(180, 180, 180);
    public static final Color LIGHT_SQUARES     = new Color(232, 235, 239);
    public static final Color DARK_SQUARES     = new Color(125, 135, 150);
